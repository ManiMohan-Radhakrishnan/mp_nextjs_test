                            ...
                            <>
                              <div className={"pop-sale-nft-info"}>
                                ...
                                <div className={"pop-sale-nft-content"}>
                                  <div
                                    className={`pop-author-name text-center`}
                                  >
                                    {nft?.category_name}
                                  </div>
                                  <div
...
const ChildAsset = ({ child = {}, i }) => {
  return (
    <div className={"pop-sale-nft-info"}>
      <div className={"pop-sale-nft-media"}>
        {(() => {
          if (child?.asset_type?.includes("image")) {
            return (
              <Image
                unoptimized={true}
                alt="media_logo"
                ...
                key={i}
                className="type_image typeimg_audio"
                src={child?.asset_url ? child?.asset_url : "/sample.gif"}
                loading="lazy"
              />
            );
          } else if (child?.asset_type?.includes("audio")) {
            return (
              <>
                <Image
                  unoptimized={true}
                  ...
                  height={250}
                  key={i}
                  src={child?.cover_url ? child?.cover_url : "/sample.gif"}
                  loading="lazy"
                />
              </>
            );
          } else if (child?.asset_type?.includes("video")) {
            return (
              <Image
                unoptimized={true}
                alt="media_logo"
      ...
      <div key={i} className={"pop-sale-nft-content"}>
        <div className={`pop-author-name text-center`}>
          {child?.category_name}
        </div>
