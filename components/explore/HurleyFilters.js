  ...
  return (
    <>
      ...
      <div className={style["filter-list-items"]}>
        ...
        >
          Categories{" "}
          {filter.showCategories ? <IoIosArrowUp /> : <IoIosArrowDown />}
        </h4>
      ...
      <div className={style["filter-list-items"]}>
        <h4
          ...
          onClick={() =>
            setFilter({
              ...filter,
              showGender: !filter.showGender,
            })
          }
        >
          Gender {filter.showGender ? <IoIosArrowUp /> : <IoIosArrowDown />}
        </h4>
        {filter.showGender && (
          <ul>
