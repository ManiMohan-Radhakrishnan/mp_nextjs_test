...
const FAQComponent = () => {
  const [tabs, setTabs] = useState([
    ...
    { id: 11, name: "Rental", active: false },
  ]);
            ...
            if (active === 1) {
                ...
                <div className="row">
                  <div className="col-12 col-md-6">
                    ...
                    <Accordian
                      head={
                        <>
                          Why can&apos;t I just download or screenshot the
                          image?
                        </>
                      }
                      body={
                        <>
                          ...
                          just the &lsquo;image&rsquo; without the attributes
                          and the properties that make the object unique, all of
                          which is stored on the blockchain. While you may
                          possess the &lsquo;image&rsquo;, it might not carry
                          the properties and attributes that make it valuable,
                          which means it is yet another image that does not
                          carry value in secondary markets.
                        </>
                      }
                      status={false}
                      index={3}
                    ...
                    <Accordian
                      ...
                      body={
                        <>
                          {" "}
                          NFTs can either be collectibles or gaming assets or
                          any other form of digital art/creation. They can also
                          be traded on NFT marketplaces depending on the
                          dynamics off the market.
                        </>
                      }
                      status={false}
                      index={5}
                    ...
                    {/* <Accordian
                      head={
                        <>
                          Considering crypto&apos;s legal stance, will my
                          NFT&apos;s value dilute at any time?
                        </>
                      }
                      body={
                        <>
                          While &lsquo;cryptocurrency&rsquo; might have its
                          share of legal uncertainty, the technology behind NFTs
                          does not have such hassles. A lot of jurisdictions are
                          catching up to accommodate this new dependable
                          technology, considering them as legally valid proofs
                          and pieces of evidence. Therefore, your NFT will
                          always hold its value. It is also to be remembered
                          that the NFT is inherently valuable and the technology
                          only serves as a tool to prove its authenticity and
                          keep a record of the NFT transactions.
                        </>
                      }
                      status={false}
                      index={6}
                    ...
                    <Accordian
                      ...
                      body={
                        <>
                          ...
                          own launchpad. Jump.trade is all set to launch
                          India&apos;s first community-centered cricket game.
                        </>
                      }
                      status={false}
                      index={15}
                ...
                <div className="row">
                    ...
                    <Accordian
                      ...
                      body={
                        <>
                          ...
                          You will need to click on the &quot;deposit&quot;
                          button available on the top left of the profile, and
                          you will be taken to a page where you can proceed to
                          fund your wallet.
                        </>
                      }
                      status={false}
                  ...
                  <div className="col-12 col-md-6">
                    ...
                    <Accordian
                      head={
                        <>
                          What if I get a transaction confirmation SMS and my
                          wallet doesn&apos;t reflect the payment?
                        </>
                      }
                      body={
                        <>
                    ...
                    <Accordian
                      head={
                        "Why is there a limit on how much funds I can withdraw from a particular payment method?"
                      }
                      body={
                        <>
                          {" "}
                          <p className="accordion-title text body-mb">
                            Jump.trade sets an upper limit on the total funds
                            withdrawable from a particular payment method based
                            on the total deposits the user has made using that
                            payment method.
                          </p>
                          <p>
                            For example, say Alice has deposited $50 using the
                            UPI payment method and another $100 using the
                            cryptocurrency payment method. Hence, when
                            withdrawing her funds from Jump.trade, Alice will
                            not be able to withdraw $75 through the UPI payment
                            method, as she earlier deposited only $50 using the
                            UPI method.
                          </p>
                          <p>
                            NOTE: The profits earned through selling NFTs will
                            fall under a different payment method called
                            &quot;Trade.&quot; Users can withdraw their profits
                            directly using the Trade payment method.
                          </p>
                        </>
                      }
                      status={false}
                ...
                <div className="row">
                    ...
                    <Accordian
                      ...
                      body={
                        <>
                          ...
                          under the &quot;my NFTs&quot; section of your profile,
                          you are eligible to sell your NFT on the Jump.trade
                          marketplace. <br />
                  ...
                  <div className="col-12 col-md-6">
                    <Accordian
                      ...
                      body={
                        <>
                          You will need to navigate to the &quot;my NFTs&quot;
                          section on your profile and click on the particular
                          NFT that you would like to list for sale. Before you
                          do so, you will need to ensure if your NFT belongs to
                          the ERC-721 category.{""}
                    ...
                    <Accordian
                      ...
                      body={
                        <>
                          ...
                          the &quot;Jump.trade wallet&quot; section of the FAQ
                          document.
                        </>
                      }
                      status={false}
              ...
              return (
                <div className="row">
                  <div className="col-12 col-md-6">
                    <Accordian
                      head={"When can I rent out/borrow MCL NFTs?"}
                      body={
                        <>
                          {" "}
                          NFTs can be rented out or borrowed at any time
                          throughout the day.
                        </>
                      }
                      status={false}
                      index={55}
                      isActivePanel={isActivePanel[55]}
                      setActivePanel={setActivePanel}
                    />
                    <Accordian
                      head={`When can I revoke my rented out NFTs?`}
                      body={
                        <>
                          NFTs listed for rent can be revoked by the owner 5
                          mins before a tournament starts or 15 mins after the
                          tournament ends.
                        </>
                      }
                      status={false}
                      index={56}
                      isActivePanel={isActivePanel[56]}
                      setActivePanel={setActivePanel}
                    />
                    <Accordian
                      head={"When can I return borrowed NFTs?"}
                      body={
                        <>
                          NFTs returned by the borrower 5 mins before a
                          tournament starts or 15 mins after the tournament
                          ends.
                        </>
                      }
                      status={false}
                      index={57}
                      isActivePanel={isActivePanel[57]}
                      setActivePanel={setActivePanel}
                    />
                    <Accordian
                      head={"Is user verification needed for borrowing NFTs?"}
                      body={
                        <>
                          {" "}
                          No, user verification is not required to borrow NFTs.
                        </>
                      }
                      status={false}
                      index={58}
                      isActivePanel={isActivePanel[58]}
                      setActivePanel={setActivePanel}
                    />
                    <Accordian
                      head={"How many NFTs can I borrow?"}
                      body={
                        <>
                          {" "}
                          A user can borrow a maximum of 1 Batter NFT, 1 Bowler
                          NFT, and 1 Bat NFT.
                        </>
                      }
                      status={false}
                      index={59}
                      isActivePanel={isActivePanel[59]}
                      setActivePanel={setActivePanel}
                    />
                    <Accordian
                      head={"What is the basic eligibility for renting NFTs?"}
                      body={
                        <>
                          {" "}
                          All registered users of jump.trade are eligible to
                          rent out/borrow NFTs.
                        </>
                      }
                      status={false}
                      index={60}
                      isActivePanel={isActivePanel[60]}
                      setActivePanel={setActivePanel}
                    />
                    <Accordian
                      head={"Where can I see the NFTs listed for rental?"}
                      body={
                        <>
                          {" "}
                          {`Click on the "Rental" menu in jump.trade or visit this
                          URL -`}{" "}
                          <span>
                            <a href="https://www.jump.trade/nft-rental">
                              https://www.jump.trade/nft-rental
                            </a>
                          </span>{" "}
                          - to view the NFTs listed for rental.
                        </>
                      }
                      status={false}
                      index={61}
                      isActivePanel={isActivePanel[61]}
                      setActivePanel={setActivePanel}
                    />
                  </div>
                  <div className="col-12 col-md-6">
                    <Accordian
                      head={"Can I list my borrowed NFTs for sale or rental?"}
                      body={
                        <> Borrowed NFTs cannot be listed for sale or rental.</>
                      }
                      status={false}
                      index={62}
                      isActivePanel={isActivePanel[62]}
                      setActivePanel={setActivePanel}
                    />
                    <Accordian
                      head={"Is revenue share common for all NFTs?"}
                      body={
                        <>
                          Revenue share is based on the level of the MCL Player
                          and MCL Bat NFTs. Borrowers can view the revenue share
                          associated with the NFT when they borrow from the
                          marketplace.
                        </>
                      }
                      status={false}
                      index={63}
                      isActivePanel={isActivePanel[63]}
                      setActivePanel={setActivePanel}
                    />
                    <Accordian
                      head={"Can I rent/borrow Raddx NFTs?"}
                      body={
                        <>
                          {" "}
                          The rental program is enabled only for MCL NFTs right
                          now.
                        </>
                      }
                      status={false}
                      index={64}
                      isActivePanel={isActivePanel[64]}
                      setActivePanel={setActivePanel}
                    />
                    <Accordian
                      head={"Where can I see my share split?"}
                      body={
                        <>
                          {" "}
                          Earnings from rented out NFTs will be part of the JT
                          points log.
                        </>
                      }
                      status={false}
                      index={65}
                      isActivePanel={isActivePanel[65]}
                      setActivePanel={setActivePanel}
                    />
                    <Accordian
                      head={"How long can I use my borrowed NFTs?"}
                      body={
                        <>
                          {" "}
                          Borrowed NFTs can be used till the NFT is revoked by
                          the owner or returned by the borrower.
                        </>
                      }
                      status={false}
                      index={66}
                      isActivePanel={isActivePanel[66]}
                      setActivePanel={setActivePanel}
                    />
                    <Accordian
                      head={"Can I return my borrowed NFT at any time?"}
                      body={
                        <>
                          {" "}
                          Borrowed NFTs can be returned only 10 minutes after
                          the borrowed time.
                        </>
                      }
                      status={false}
                      index={67}
                      isActivePanel={isActivePanel[67]}
                      setActivePanel={setActivePanel}
                    />
                  </div>
                </div>
...
const Accordian = ({
  ...
  return (
    <div className={style["c-accordian"]}>
      <div className={style["c-accor-head"]} onClick={() => toggleItem(index)}>
        <FaFileAlt color={"#faaa47"} size={20} />

        <div className={style["head-area"]}>{head}</div>

        {isActivePanel ? (
          <FaMinusCircle color={"#faaa47"} size={20} />
        ) : (
          <FaPlusCircle color={"#faaa47"} size={20} />
        )}
      </div>
      {isActivePanel && <div className={style["c-accor-body"]}>{body}</div>}
    </div>
  );
};
