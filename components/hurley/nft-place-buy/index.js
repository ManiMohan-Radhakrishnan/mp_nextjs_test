...
import { getNftPriceBreakup, nftBuyApi } from "../../../utils/methods";
...
const NFTPlaceBuy = ({
  ...
  const buy_amount = orderDetails?.buy_amount;
  ...
  const handleBuy = async () => {
    ...
    try {
      ...
      const err = bidBuyError(error?.respons?.data?.fail_status);
      setBuy({
        ...buy,
        isError: true,
        progressError: "error-progress",
                                  ...
                                  onClick={() => {
                                    ...
                                    invokeTrackEvent(
                                      EVENT_NAMES.CHECKOUT_COMPLETED,
                                      {
                                        ...
                                        "Cash Rewards Points":
                                          parseInt(reward_point_balance),
                                        "JT Points": jump_point_balance,
                                        "Buy Price": parseFloat(
                                          nftPriceBreakup?.total
                                        )
                                          ? parseFloat(nftPriceBreakup?.total)
                                          : null,
