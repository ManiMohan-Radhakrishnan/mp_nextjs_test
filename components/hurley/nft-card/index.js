...
const HurleyNFTCard = ({
  ...
  const levelData = hurleyLevels(nft?.core_statistics?.level?.value);
  ...
  const playerCatData = hurleyCategory(nft?.core_statistics?.category?.value);
