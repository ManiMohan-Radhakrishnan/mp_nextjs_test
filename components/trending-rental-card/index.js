...
const TrendingRentalCard = ({ details, player }) => {
  ...
  category =
    player === "Batsman" || player === "Bowler" ? "mcl_player" : "mcl_bat";

  const isPlayer = category === "mcl_player";
  const isBat = category === "mcl_bat";
...
export default TrendingRentalCard;
