          ...
          <div className="col">
            <div className={style["head-section-block"]}>
              ...
              <p className={`${style["desc-section"]} mb-0`}>
                Dominate the season with your free Seasonal Pass! Unleash your
                inner champion and rack up the wins!
              </p>
              {/* <div className={style["section-heading"]}>
                <h2>HOW TO WIN APT TOKENS</h2>
                <p>
                  Join the Mcl Season Pass Tournament and Compete for $5,0000
                  Worth of Aptos (APT) Tokens Airdrop!
                </p>
              </div> */}
...
export default MclSeasonPassBanner;
