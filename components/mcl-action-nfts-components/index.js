...
const LootBoxSection = ({ buySuccess = () => {}, details }) => {
              ...
              <div className={style["loot-block"]}>
                <div className={style["loot-section"]}>
                  <div className={`${style["items"]} ${style["one"]}`}>
                    ...
                    <p>
                      The MCL Signature Shots — Mystery Box features Unique
                      Batting Shot NFTs that are equipable for all MCL Batters.
                      These shots bring the flair of legendary real-world
                      cricket heroes to the MCL game. Created with cutting-edge
                      Motion-Capture Technology, the Signature Shot NFTs will
                  ...
                  <div className={`${style["items"]} ${style["two"]}`}>
                    <div className={`${style["box-block"]}`}>
                      <h6>Every Mystery Box Contains</h6>
                      <p className={style["loot-desc"]}>
                        1 MCL Signature Shot NFT
                      </p>
                    </div>
                  </div>
                  <div className={`${style["items"]} ${style["three"]}`}>
                    <div className={`${style["box-block"]}`}>
                      <h6>MCL Signature Shot — Mystery Box Price</h6>
                ...
                >
                  <video
                    ...
                    loop
                    src={images.mcl_action_video_new}
                    poster={LootImage}
                    playsInline
                    muted={mutedVideo}
                    autoPlay
