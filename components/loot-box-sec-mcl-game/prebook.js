...
const Prebook = ({ show = false, toggleModal = () => {}, modalState = {} }) => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="fs-4">PRE-BOOK SUPER LOOT BOX</span>
      </Modal.Header>
          ...
          <>
            <div className="d-flex flex-column text-dark preorder-popup-top">
              ...
              <div className={style["input-block-row"]}>
                ...
                <p>
                  {`${currencyFormat(
                    parseFloat(user?.jump_points_balance / 10000) || 0
                  )}`}
                </p>
                ...
                <>
                  ...
                  <div className={style["input-block-row"]}>
                    <h6>{`Used JT Points (${parseInt(
                      breakUp?.price_from_jt * 10000
                    )} JT)`}</h6>
                    <p>{`- ${currencyFormat(breakUp?.price_from_jt)}`}</p>
                  </div>
                </>
              )}
              {breakUp?.allowBuy && (
              ...
              {breakUp?.sub_total > 0 && !breakUp?.allowBuy && (
                <>
                  ...
                  >
                    <h6 className="m-0 fw-bold">Pre-book your NFT by adding</h6>
                    <p className="m-0 fw-bold">
                      {currencyFormat(breakUp?.amount_to_be_added || 0)}
                    </p>
                  </div>
                </>
              )}
                ...
                !breakUp?.allowBuy ? (
                  <>
                    ...
                    >
                      ...
                      <PaymentMethod
                        defaultAmount={breakUp?.amount_to_be_added}
                      />
                      {/* </div> */}
                    </div>
                  </>
                  ...
                  >
                    <button onClick={onPurchase} className={style["theme-btn"]}>
