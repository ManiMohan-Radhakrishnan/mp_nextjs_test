...
const EliteFounderPassBoxDetails = ({ buySuccess = () => {}, details }) => {
    ...
    <>
      <section className={style["main-loot-section"]}>
          ...
          <div className="row">
            <div className="col-sm-12">
              <div className={`${style["sec-header"]}`}>
                ...
                />
                <p>
                  Step into the coveted circle of elite players and unleash your
                  true potential with the prestigious MCL Elite Founder Pass.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className={style["loot-section"]}>
                  ...
                  <div className={`${style["items"]} ${style["two"]}`}>
                    ...
                    <div className={`${style["box-block"]}`}>
                      ...
                      <h4>1 MCL Elite Founder Pass NFT</h4>
                        ...
                        <div className={style["price-list-box"]}>
                          <div className={style["pack-price-flex"]}>
                            <div className={style["pack-price-heading"]}>
                              <h3>1 ELITE FOUNDER Pass Box</h3>{" "}
                            </div>
        ...
        {modalType === MODAL_TYPES.PREBOOK && (
          <>
            {ENABLE_REWARD_BUY && (
              <MclEliteFounderPassPrebook
                show={modalType === MODAL_TYPES.PREBOOK}
                toggleModal={toggleModal}
                modalState={modalState}
                onReload={buySuccess}
                slug={process.env.NEXT_PUBLIC_MCL_ELITE_FOUNDER_PASS_SLUG}
...
export default EliteFounderPassBoxDetails;
