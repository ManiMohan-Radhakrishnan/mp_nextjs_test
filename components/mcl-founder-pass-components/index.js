...
const FounderPassBoxDetails = ({ buySuccess = () => {}, details }) => {
  ...
  return (
    <>
      <section className={`${style["founder-pass-hero-section"]} `}>
        <Image
          unoptimized={true}
          height="800"
          width="1920"
          ...
          <div className="row">
            <div className="col-sm-12">
              <div className={`${style["sec-header"]}`}>
                ...
                />
                <p>
                  Spark your gaming experience, unleash exclusive benefits, and
                  discover the limitless possibilities using founder pass.
                </p>
              </div>
            </div>
          </div>
...
export default FounderPassBoxDetails;
